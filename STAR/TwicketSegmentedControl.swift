...
//        let cornerRadius = backgroundView.frame.height / 2
        ...
        [backgroundView].forEach { $0.layer.cornerRadius = 0 }
		selectedContainerView.layer.cornerRadius = backgroundView.frame.height / 2
        sliderView.cornerRadius = backgroundView.frame.height / 2
